...
async def callback_google_sheets_url(
    ...
    if answer == "yes":
        ...
        await callback.message.answer(f"Теперь пришлите файл DataExport-...")
